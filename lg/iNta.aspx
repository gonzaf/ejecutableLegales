<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.master" CodeBehind="iNta.aspx.vb" Inherits="Dynamic_Data.iNta" %>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td><a href="<%= String.Concat("/docs/", eN.idParte, "-", eN.idNota, "-not-", a)%>" target="verFoto"><%=a %></a></td>
                                                                </tr>
                                                                <% next %>
                                                            </table>
                                                        </div>
