<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.master" CodeBehind="iRqs.aspx.vb" Inherits="Dynamic_Data.iRqs" %>
                            ...
                            <div class="panel-body">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <span class="label bg-danger pull-right">Reclamo</span>
                                                ...
                                                <EditItemTemplate>
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <asp:DropDownList ID="ddTipoNota" CssClass="form-control" runat="server" DataSourceID="LinqDataSource1" DataTextField="Requisito" DataValueField="idRequisito">
                                                               
                                                            </asp:DropDownList>
                                                            <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="legLinq.LegalesDataContext" EntityTypeName="" TableName="tRequisitos" Where="Tipo == @Tipo">
                                                                <WhereParameters>
