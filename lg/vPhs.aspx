<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="vPhs.aspx.vb" Inherits="Dynamic_Data.vPhs" %>
        ...
        <div id="myCarousel" class="carousel slide" data-interval="false" data-ride="carousel">
            ...
            <ol class="carousel-indicators">
                <%  
                    ...
                    For i As Integer = 1 To docs2.Count
            ...
            <div class="carousel-inner" role="listbox">
               ...
               <%  For each a As String In docs2
                ...
                <div class="item <%=ac %>">
                    <a href="<%=a %>" target="vPggg">
                        <img src="<%=a %>" alt="Fotos" width="460" height="345">
                    </a>
