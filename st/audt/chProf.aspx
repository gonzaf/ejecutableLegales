<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/st/SiteST.master" CodeBehind="chProf.aspx.vb" Inherits="Dynamic_Data.chProf" %>
                                ...
                                <section class="panel">
                                    <header class="panel-heading">
                                        ...
                                        <div class="form-inline">
                                            Cambiar Medicion de Profundidad&nbsp;&nbsp; 
                                        </div>
                                    </header>
                                    <div class="panel-body" style="padding: 10px 30px 10px 30px">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-sm-8">
                                                    <label for="detalle">Medicion de Profundiad</label>
                                                    <asp:TextBox Visible="false" ID="TextBox1" Enabled="false" runat="server" ClientIDMode="Static" data-next="ubicacion" data-button="buttonCoche" CssClass="form-control input-sm " Text=""></asp:TextBox>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    <label for="detalle">Profundidad</label>
