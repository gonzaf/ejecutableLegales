<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/st/SiteST.master" CodeBehind="cmbEst.aspx.vb" Inherits="Dynamic_Data.cmbEst" %>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    ...
                                                    <asp:DropDownList ID="ddUbic" CssClass="form-control input-sm entTab" ClientIDMode="Static" runat="server" DataTextField="Estado" DataValueField="id"></asp:DropDownList>
                                                </div>
                                                <div class="col-sm-0">
                                                </div>
                                            </div>
