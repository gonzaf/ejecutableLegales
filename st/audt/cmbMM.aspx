<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/st/SiteST.master" CodeBehind="cmbMM.aspx.vb" Inherits="Dynamic_Data.cmbMM" %>
                                ...
                                <section class="panel">
                                    ...
                                    <div class="panel-body" style="padding: 10px 30px 10px 30px">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <label for="ddUbic">Marca/Modelo</label>
                                                    <asp:DropDownList ID="ddUbic" CssClass="form-control input-sm entTab" ClientIDMode="Static" runat="server" DataTextField="text" DataValueField="id"></asp:DropDownList>
                                                </div>
                                                <div class="col-sm-0">
                                                </div>
                                            </div>
