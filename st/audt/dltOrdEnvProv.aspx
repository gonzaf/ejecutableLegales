<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/st/SiteST.master" CodeBehind="dltOrdEnvProv.aspx.vb" Inherits="Dynamic_Data.dltOrdEnvProv" %>
                                ...
                                <section class="panel">
                                    <header class="panel-heading">
                                        ...
                                        <div class="form-inline">
                                            Eliminar Orden Envio de Repuestos a Prov.&nbsp;&nbsp; 
                                        </div>
                                    </header>
                                    <div class="panel-body" style="padding: 10px 30px 10px 30px">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                   <label for="detalle">Nro.Comprobante</label>
                                                    ...
                                                    <asp:Button ID="buttonPrecio" OnClick="buttonPrecio_Click" OnClientClick="return finalizar();" ClientIDMode="Static" CssClass=" btn form-control btn-primary btn-xs" runat="server" Text="Eliminar" />
                                                </div>
                                                <div class="col-sm-4">
