<%@ Page Title="" Language="vb" AutoEventWireup="false" ValidateRequest="false" EnableEventValidation="false" MasterPageFile="~/st/SiteST.master" CodeBehind="cBjas.aspx.vb" Inherits="Dynamic_Data.cBjas" %>
                                        ...
                                        <div class="panel">
                                            ...
                                            <asp:GridView ID="gvPartes" HeaderStyle-HorizontalAlign="Center" runat="server" DataKeyNames="id" AutoGenerateColumns="False" DataSourceID="dsPartes" CssClass="table table-striped m-b-none text-small" BorderStyle="None" GridLines="None" OnSelectedIndexChanged="gvPartes_SelectedIndexChanged" OnPreRender="GVPreRender">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Fecha Baja" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="30px">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label2" runat="server" Text='<%# Format(Eval("fechaBaja"), "dd/MM/yy")%>'></asp:Label>
                                                    ...
                                                    <asp:BoundField DataField="kmsAlUltimoCambio" HeaderText="Kms"></asp:BoundField>
                                                    <asp:BoundField DataField="deposito" HeaderText="Deposito"></asp:BoundField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Mas Info." ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="30px" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lmMasInfo" ToolTip="Ingresar" OnCommand="lmMasInfo_Command" CommandArgument='<%#Eval("id")%>' runat="server">Mas Info.</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="Imprimir" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="30px" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:LinkButton Visible="true" ID="lbImprimir" ToolTip="Ingresar" OnCommand="lbIngresar_Command" CommandArgument='<%#Eval("id")%>' runat="server">Imprimir</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                            ...
                                            <asp:LinqDataSource ID="dsPartes" runat="server" ContextTypeName="legLinq.LegalesDataContext" EntityTypeName="" OrderBy="nroPartida" TableName="vStBajas" >
                                                <WhereParameters>
