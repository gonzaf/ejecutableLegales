<%@ Page Title="" Language="vb" AutoEventWireup="false" ValidateRequest="false" EnableEventValidation="false" MasterPageFile="~/st/SiteST.master" CodeBehind="envCub-Copia.aspx.vb" Inherits="Dynamic_Data.envCubCopia" %>
                                ...
                                <section class="panel">
                                    <header class="panel-heading">
                                        ...
                                        <div class="form-inline">
                                            Envio de Cubiertas a Proveedores&nbsp;&nbsp;
                                    ...
                                    <section style="//height: 200px" class="panel-body scrollbar scroll-y m-b">
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Fecha" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="30px">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:HiddenField ID="idEstado" ClientIDMode="Static" runat="server" Value='<%# Eval("stPartidas1.idEstado")%>' />
                                                            <asp:HiddenField ID="idCubierta" ClientIDMode="Static" runat="server" Value='<%# Eval("idPartidaSacada")%>' />
                                                            
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:BoundField DataField="stOrdenGomeriaDetalle.stOrdenGomeria.nroOrden" HeaderText="# Orden Gomeria" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="Linea"></asp:BoundField>
                                                    <asp:BoundField DataField="stOrdenGomeriaDetalle.stOrdenGomeria.stDepositos.deposito" HeaderText="Deposito" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="Linea"></asp:BoundField>
                                                    <asp:BoundField DataField="stPartidas1.stTiposCubiertas.completo" HeaderText="Cubierta" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="Linea"></asp:BoundField>
                                                    <asp:BoundField DataField="stPartidas1.stEstado.estado" HeaderText="Estado" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="Linea"></asp:BoundField>
                                                    <asp:BoundField DataField="stPartidas1.nroPartida" HeaderText="Partida" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="Linea"></asp:BoundField>
                                        ...
                                        <asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="legLinq.LegalesDataContext" EntityTypeName="" TableName="stTipoAccionRevision" Where="cubiertas == true and id > 5 and id <> 9">
                                        </asp:LinqDataSource>
