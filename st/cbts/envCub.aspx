<%@ Page Title="" Language="vb" AutoEventWireup="false" ValidateRequest="false" EnableEventValidation="false" MasterPageFile="~/st/SiteST.master" CodeBehind="envCub.aspx.vb" Inherits="Dynamic_Data.envCub" %>
                            ...
                            <div class="panel-body">
                                <section class="panel">
                                    ...
                                    <section style="//height: 200px" class="panel-body scrollbar scroll-y m-b">
                                        ...
                                        <asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="legLinq.LegalesDataContext" EntityTypeName="" TableName="stTipoAccionRevision" Where="cubiertas == true and id > 5 and id <> 9 and id <> 11">
                                        </asp:LinqDataSource>
