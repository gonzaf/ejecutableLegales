<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="prBjas.aspx.vb" Inherits="Dynamic_Data.prBjas" %>
...
<body onload="imrimeyredi()" class="imprimir">
    <table width="650" align="center">
        <tr>
            ...
            <td width="464" style="width: 232px" colspan="2">
                <p class="titulo">
                    Bajas de cubiertas del dia <%=fecha %>
                </p>
                <p class="cuerpo">
                </p>
            </td>
                        ...
                        <HeaderTemplate>
                            <table width="100%" border="1" cellspacing="0" cellpadding="3">
                                <tr>
                                    ...
                                    <td align="middle" class="bordefull">
                                        <p align="center" class="chico">Estado</p>
                                    </td>
                                    <td height="23" align="middle" class="bordefull">
                                        <p align="center" class="chico">Fec.Inicio</p>
                                    </td>
                                    <td height="23" align="middle" class="bordefull">
                                        <p align="center" class="chico">Motivo</p>
                                    </td>
                                     <td height="23" align="middle" class="bordefull">
                                        <p align="center" class="chico">Deposito</p>
                                    </td>
                                </tr>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <tr>
                                <td align="center" width="40" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label1" Text='<%# Eval("nroPartida") %>' />
                                    </p>
                                </td>
                                <td align="center" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label2" Text='<%# Eval("tipo") %>' />
                                    </p>
                                </td>
                                <td align="center" width="40" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label5" Text='<%# Eval("estado") %>' />
                                    </p>
                                </td>
                                <td align="center" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label3" Text='<%# Eval("fechaInicio") %>' />
                                    </p>
                                </td>
                                <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label4" Text='<%# Eval("motivo") %>' />
                                    </p>
                                </td>
                                <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label6" Text='<%# Eval("deposito") %>' />
                                    </p>
                                </td>
    ...
    <td width="10">
        <br>
        <br>
        Autorizo: ________________________________</td>
    </TR>
  </TBODY>
