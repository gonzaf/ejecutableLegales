<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="prRcl.aspx.vb" Inherits="Dynamic_Data.prRcl" %>
    ...
    <table width="600" align="center">
        <tr>
            ...
            <td width="124" class="cuerpo">
                ...
                <p class="cuerpo" style="text-align: right">Nro: <%=idReclamo %></p>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td align="center" width="40" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label1" Text='<%# Eval("stPartidas.nroPartida") %>' />
                                    </p>
                                </td>
                                <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label2" Text='<%# Eval("stPartidas.stTiposCubiertas.completo") %>' />
                                    </p>
                                </td>
                                <td align="center" width="40" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label3" Text='<%# Eval("stEstado.estado") %>' />
                                    </p>
                                </td>
                                ...
                                <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label6" Text='<%# Eval("obsIda") %>' />
                                    </p>
                                </td>
