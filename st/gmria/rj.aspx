<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/st/SiteST.master" CodeBehind="rj.aspx.vb" Inherits="Dynamic_Data.rj" %>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-sm-12 text-right m-t-large">
                                                    ...
                                                    <asp:Button ID="Enviar" OnClientClick="this.style.visibility = 'hidden'" runat="server" Enabled="true" Text="Confirmar" Visible="true" CssClass="btn btn-primary btn-xs" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
