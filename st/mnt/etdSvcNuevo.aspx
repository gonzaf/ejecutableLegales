<%@ Page Title="" Language="vb" AutoEventWireup="false" ValidateRequest="false" EnableEventValidation="false" MasterPageFile="~/st/SiteST.master" CodeBehind="etdSvcNuevo.aspx.vb" Inherits="Dynamic_Data.etdSvcNuevo" %>
                                    ...
                                    <header class="panel-heading">
                                        ...
                                        <div class="form-inline">
                                            ...
                                            <asp:DropDownList ID="ddOrden" runat="server" CssClass="form-control input-sm entTab">
                                                ...
                                                <asp:ListItem Text="Kms.Restantes" Value="kmsRestantes"></asp:ListItem>
                                            ...
                                            <br />
                                            <br />
                                            <asp:CheckBox Visible="true" ID="cbPreventivoKms" runat="server" Checked="false" Text="Preventivo Kms" />
                                            &nbsp;&nbsp;
                                        ...
                                        <div class="panel">
                                            ...
                                            <asp:GridView ID="gvPreventivo" runat="server" AutoGenerateColumns="False" CssClass="table table-striped m-b-none text-small" BorderStyle="None" GridLines="None" OnSelectedIndexChanged="gvPartes_SelectedIndexChanged" OnPreRender="GVPreRender">
                                                <Columns>
                                                  ...
                                                  <asp:TemplateField HeaderText="Prox" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="30px">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("kmsUltServ") + Eval("frecuencia")%>' Visible='<%#IIf(Eval("controlDias") = "0", "true", "false")%>'></asp:Label>
                                                            <asp:Label ID="Label1" runat="server" Text='' Visible='<%#IIf(Eval("controlDias") = "1", "true", "false")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="Restantes" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="30px">
                                                        <ItemTemplate>
                                                            <%--<asp:Label ID="Labelss2" runat="server" Text='<%#IIf(Eval("controlDias") = 1, "Dias", "Kms")%>'></asp:Label>--%>
                                                            <%--<asp:Label ID="Labelss2" runat="server" Text='<%# Eval("kmsActuales") - Eval("kmsUltServ")%>' Visible='<%#IIf(Eval("controlDias") = "0", "true", "false")%>'></asp:Label>
                                                            <asp:Label ID="Label1" runat="server" Text='<%# DateDiff(DateInterval.Day, Eval("fechaUltServ"), Now())%>' Visible='<%#IIf(Eval("controlDias") = "1", "true", "false")%>'></asp:Label>--%>
                                                            <asp:Label ID="Label334" runat="server" Text='<%# Eval("frecuencia") - Eval("kmsParciales")%>' Visible='<%#IIf(Eval("controlDias") = "0", "true", "false")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Kms.Prox" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="proximo" runat="server" Width="100" Text='<%# Eval("kmsProxServ")%>' CssClass="form-control input-sm entTab"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
