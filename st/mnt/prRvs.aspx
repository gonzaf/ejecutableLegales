<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="prRvs.aspx.vb" Inherits="Dynamic_Data.prRvs" %>
                            ...
                            <table width="100%" border="1" cellspacing="0" cellpadding="3">
                                <tr>
                                    <td align="middle" class="bordefull" height="23">
                                        <p align="center" class="chico">Nro.Coche</p>
                                    </td>
                                    <td align="middle" class="bordefull">
                                        <p align="center" class="chico">Tarea</p>
                                    </td>
                                    <td align="middle" class="bordefull">
                                        <p align="center" class="chico">Fec.Ult.Serv</p>
                                    </td>
                                    <td height="23" align="middle" class="bordefull">
                                        <p align="center" class="chico">Kms.Ult.Serv.</p>
                                    </td>
                                    <td height="23" align="middle" class="bordefull">
                                        <p align="center" class="chico">Kms.Actuales</p>
                                    </td>
                                     <td height="23" align="middle" class="bordefull">
                                        <p align="center" class="chico">Tope</p>
                                    </td>
                                    <td height="23" align="middle" class="bordefull">
                                        <p align="center" class="chico">Frecuencia</p>
                                    </td>
                                </tr>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <tr>
                                <td align="center" width="40" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label1" Text='<%# Eval("nroCoche") %>' />
                                    </p>
                                </td>
                                <td align="center" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label2" Text='<%# Eval("tarea") %>' />
                                    </p>
                                </td>
                                <td align="center" width="40" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label5" Text='<%# Format(Eval("fechaUltServ"), "dd/MM/yy") %>' />
                                    </p>
                                </td>
                                <td align="center" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label3" Text='<%# Eval("kmsUltServ") %>' />
                                    </p>
                                </td>
                                <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label4" Text='<%# Eval("kmsActuales") %>' />
                                    </p>
                                </td>
                                <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label6" Text='<%#IIf(Eval("controlDias") = 1, "Dias", "Kms")%>' />
                                    </p>
                                </td>
                                   <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label7" Text='<%# Eval("frecuencia") %>' />
                                    </p>
                                </td>
