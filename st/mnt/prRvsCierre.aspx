<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="prRvsCierre.aspx.vb" Inherits="Dynamic_Data.prRvsCierre" %>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label2" Text='<%# Eval("descripcion") %>' />
                                    </p>
                                </td>
                                <td align="center" width="40" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label5" Text='<%# Format(Eval("fechaCierre"), "dd/MM/yy") %>' />
                                    </p>
                                </td>
                                <td align="center" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label3" Text='<%# Eval("kmsCierre") %>' />
                                    </p>
                                </td>
                                <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label4" Text='<%# Eval("kmsCierre") %>' />
                                    </p>
                                </td>
                                <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
