<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="prEnvRep.aspx.vb" Inherits="Dynamic_Data.prEnvRep" %>
    ...
    <table width="600" align="center">
        <tr>
            ...
            <td width="464" style="width: 232px" colspan="2">
                <p class="titulo">
                    Envio a Reparar Nº: <%=idImpresion %>
                </p>
                <p class="cuerpo">
                    Fecha: <%=fecha %>
                </p>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center" width="40" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label3" Text='<%# Eval("cantenviadaproveedor") %>' />
                                    </p>
                                </td>
                                ...
                                <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label6" Text='<%# Eval("obsEnvio") %>' />
                                    </p>
                                </td>
