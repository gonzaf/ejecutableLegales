<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="prRcPro.aspx.vb" Inherits="Dynamic_Data.prRcPro" %>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center" width="60" class="bordefull">
                                 ...
                                 <td align="center" width="60" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label4" Text='<%# Eval("obsEnvio") %>' />
                                    </p>
                                </td>
