<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="prRec.aspx.vb" Inherits="Dynamic_Data.prRec" %>
    ...
    <table width="600" align="center">
        <tr>
            ...
            <td width="464" style="width: 232px" colspan="2">
                <p class="titulo">
                    Recepcion de Repuestos Nº: <%=idImpresion %> 
                </p>
                 <p class="cuerpo">
                    Fecha: <%=fecha %> 
                </p>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                <tr>
                                    ...
                                    <td align="middle" class="bordefull">
                                      ...
                                      <td align="middle" class="bordefull">
                                        <p align="center" class="chico"># Comp.</p>
                                    </td>
                                    <td height="23" align="middle" class="bordefull">
                                        <p align="center" class="chico">Cant.Desechar</p>
                                    </td>
                                     <td height="23" align="middle" class="bordefull">
                                        <p align="center" class="chico">Cant.Reingresada</p>
                                    </td>
                                    <td height="23" align="middle" class="bordefull">
                            ...
                            <tr>
                                ...
                                <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                      ...
                                      <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label7" Text='<%# Eval("idImpresion") %>' />
                                    </p>
                                </td>
                                <td align="center" width="40" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label3" Text='<%# Eval("cantDesechada") %>' />
                                    </p>
                                </td>
                                <td align="center" width="40" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label4" Text='<%# Eval("cantReingresada") %>' />
                                    </p>
                                </td>
                                ...
                                <td align="center" width="*" class="bordefull">
                                    <p class="cuerpo">
                                        <asp:Label runat="server" ID="Label6" Text='<%# Eval("obsRecepcion") %>' />
                                    </p>
                                </td>
