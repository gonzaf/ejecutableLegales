<%@ Page Title="" Language="vb" AutoEventWireup="false" ValidateRequest="false" EnableEventValidation="false" MasterPageFile="~/st/SiteST.master" CodeBehind="rcPro.aspx.vb" Inherits="Dynamic_Data.rcPro" %>
                                    ...
                                    <section style="//height: 200px" class="panel-body scrollbar scroll-y m-b">
                                        <div class="panel">
                                             <div class="panel col-lg-2">
                                                 <p>Proveedor</p>
                                              <asp:DropDownList ID="ddProveedor"  DataSourceID="LinqDataSource4" DataTextField="proveedor" DataValueField="idProveedor" runat="server" AutoPostBack="false" CssClass="form-control col-6 input-sm entTab">
                                                            </asp:DropDownList>
                                                 </div>
