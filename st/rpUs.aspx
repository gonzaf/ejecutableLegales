                                ...
                                <section class="panel">
                                    <header class="panel-heading">
                                        ...
                                        <div class="form-inline">
                                            ...
                                            &nbsp;&nbsp;
                                            <asp:CheckBox ID="cbMostrarTodo" AutoPostBack="true" OnCheckedChanged="cbMostrarTodo_CheckedChanged" runat="server" Enabled="false" Checked="false" Text="Ver Todos los dias" />
                                    ...
                                    <section style="//height: 200px" class="panel-body scrollbar scroll-y m-b">
                                        <div class="panel">
                                            <asp:GridView ID="gvPartes" runat="server" DataKeyNames="idOrden" AutoGenerateColumns="False" DataSourceID="dsPartes" CssClass="table table-striped m-b-none text-small" BorderStyle="None" GridLines="None" OnSelectedIndexChanged="gvPartes_SelectedIndexChanged" OnPreRender="GVPreRender">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Nro.OE" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="30px" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:BoundField DataField="codRepuesto" HeaderText="Cod. Repuesto" ItemStyle-Width="30px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="Linea"></asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="cant" HeaderText="Cant." HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="Linea"></asp:BoundField>
                                                    <asp:BoundField DataField="usuarioPanolrepuesto" HeaderText="U.Pañol" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="30px" ReadOnly="True" SortExpression="Linea"></asp:BoundField>
                                                    <asp:BoundField DataField="idCoche" HeaderText="Interno" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="30px" ReadOnly="True" SortExpression="Interno"></asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="Legajo" HeaderText="Legajo" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="30px" ReadOnly="True" SortExpression="Legajo"></asp:BoundField>
                                                    <asp:BoundField DataField="kmsDesdeUltCambio" HeaderText="Rend." ItemStyle-Width="30px" ItemStyle-HorizontalAlign="Center"  DataFormatString="{0:N0}" HeaderStyle-HorizontalAlign="Center" SortExpression="Linea"></asp:BoundField>
                                                    <asp:BoundField DataField="kmsEsperados" HeaderText="Rend. Esperado" ItemStyle-Width="30px" ItemStyle-HorizontalAlign="Center"  DataFormatString="{0:N0}" HeaderStyle-HorizontalAlign="Center" SortExpression="Linea"></asp:BoundField>
