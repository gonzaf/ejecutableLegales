<%@ Page Title="" Language="vb" AutoEventWireup="false" ValidateRequest="false" EnableEventValidation="false" MasterPageFile="~/st/SiteST.master" CodeBehind="stA.aspx.vb" Inherits="Dynamic_Data.stA" %>
                            ...
                            <div class="panel-body">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <span class="label bg-danger pull-right">Stock Actual Por Articulos</span>
                                        <div class="form-inline">
                                            Stock Actual por Articulos
